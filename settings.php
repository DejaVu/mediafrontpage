...
<!-- General/Global Settings -->
            ...
            <img src="media/Programs/config.png">
            <table>
                   <tr>
                ...
                <td align="left"><p>
                    <input type="checkbox"  Title="Tick to Enable" name="ENABLED" <?php echo ($config->get('ENABLED','GLOBAL')=="true")?'CHECKED':'';?>>
                </td>
              </tr>
                   <tr>
                <td align="right"><p>Global IP:</p></td>
                <td align="left"><p>
                    <input name="URL" size="20" Title="Insert IP Address or Network Name" value="<?php echo $config->get('URL','GLOBAL')?>">
                </td>
              </tr>
                   <tr>
                <td align="right"><p>Global Authentication:</p></td>
                <td align="left"><p>
                    <input type="checkbox" Title="Tick to Enable" name="AUTHENTICATION" <?php echo ($config->get('AUTHENTICATION','GLOBAL') == "true")?'CHECKED':'';?>>
                  </p></td>
              </tr>
                   <tr>
...
<!-- WEBROOT/REVERSE PROXY Settings -->
            ...
            <h3>Reverse Proxy Settings</h3>
            <img src="media/Programs/reverse.png">
            <table>
                   <tr>
                ...
                <td align="left"><p>
                    <input type="checkbox" Title="Tick To Enable" name="ENABLED" <?php echo ($config->get('ENABLED','WEBROOT')=="true")?'CHECKED':'';?>>
                  </p></td>
              </tr>
                   <tr>
...
<!-- XBMC Settings -->
            ...
            <h3>XBMC Settings</h3>
            <a href="http://www.xbmc.org" target="_blank"><img src="media/Programs/XBMC.png" Title="Visit XBMC"></a>
            <table>
                   <tr>
                <td colspan="2"><p align="justify" style="width: 500px;">To connect with XBMC, you need to enable a few settings in Network Settings within XBMC.<i><br>
                    <br>
                    Allow control of XBMC via HTTP<br>
                    Allow programs on this system to control XBMC<br>
                    Allow programs on other systems to control XBMC.</i></p></td>
              </tr>
                   <tr>
...
<!-- Sickbeard Settings -->
            ...
            <h3>SickBeard Settings</h3>
            <a href="http://www.sickbeard.com" target="_blank"><img src="media/Programs/SickBeard.png" Title="Visit SickBeard"></a>
            <table>
                   <tr>
...
<!-- SabNZBd+ Settings -->
            ...
            <a href="http://sabnzbd.org" target="_blank"><img src="media/Programs/SabNZBd.png" Title="Visit SabNZBd+"></a>
            <table>
                   <tr>
...
<!-- Transmission Settings -->
            ...
            <a href="http://www.transmissionbt.com" target="_blank"><img src="media/Programs/Transmission.png" Title="Visit Transmission"></a>
            <table>
                   <tr>
...
<!-- uTorrent Settings -->
            ...
            <h3>uTorrent Settings</h3>
            <a href="http://www.utorrent.com" target="_blank"><img src="media/Programs/uTorrent.png" Title="Visit uTorrent"></a>
            <table>
                   <tr>
...
<!-- jDownloader Settings -->
            ...
            <h3>jDownloader Settings</h3>
            <a href="http://jdownloader.org/home/index?s=lng_en" target="_blank"><img src="media/Programs/jDownloader.png" Title="Visit jDownloader"></a>
            <table>
                   <tr>
...
<!-- Subsonic Settings -->
            ...
            <h3>SubSonic Settings</h3>
            <a href="http://www.subsonic.org/pages/index.jsp" target="_blank"><img src="media/Programs/SubSonic.png" Title="Visit SubSonic"></a>
            <table>
                   <tr>
...
<!-- Headphones Settings -->
            ...
            <h3>HeadPhones Settings</h3>
            <a href="https://github.com/rembo10/headphones" target="_blank"><img src="media/Programs/HeadPhones.png" Title="Visit HeadPhones"></a>
            <table>
                   <tr>
...
<!-- Search Settings -->
            ...
            <h3>Search Widget Settings</h3>
            <img src="media/Programs/search.png">
            <table>
                   <tr>
                ...
                <td align="left"><p>
                    <input type="radio" Title="Tick to Enable NZBMatrix" name="preferred_site" value="1" <?php echo ($config->get('preferred_site','SEARCH')=="1")?'CHECKED':'';?> />
                    NZB Matrix
                    <input type="radio" Title="Tick to Enable NZB.SU" name="preferred_site" value="2" <?php echo ($config->get('preferred_site','SEARCH')=="2")?'CHECKED':'';?> />
                    NZB.SU</p></td>
              </tr>
                   <tr>
...
<!-- ShareThe.TV Settings -->
            ...
            <h3>ShareThe.TV Settings</h3>
            <a href="http://www.sharethe.tv" target="_blank"><img src="media/Programs/ShareTheTV.png" Title="Visit ShareThe.TV"></a>
            <table>
                   <tr>
                ...
                <td align="left"><input name="SHARETHETV_USERNAME" Title="Insert your ShareThe.TV Username" size="20" value="<?php echo $config->get('SHARETHETV_USERNAME','SHARETHETV')?>" />
                       &nbsp;&nbsp;<font size='1'>Must be all lowercase.</font></td>
              </tr>
                   <tr>
...
<!-- Security Settings -->
            ...
            <img src="media/Programs/security.png">
            <table>
                   <tr>
                ...
                <td align="left"><p>
                    <input type="checkbox" Title="Tick to Enable" name="PASSWORD_PROTECTED" <?php echo ($config->get('PASSWORD_PROTECTED','SECURITY') == "true")?'CHECKED':'';?> />
                  </p></td>
              </tr>
                   <tr>
                ...
                <td align="left"><p>
                    <input type="checkbox" Title="Tick to Enable" name="mfpsecured" <?php echo ($config->get('mfpsecured','SECURITY') == "true")?'CHECKED':''; ?>>
                  </p></td>
              </tr>
                   <tr>
...
<!-- CSS Modification Settings -->
            ...
            <img src="media/Programs/cssmod.png">
            <table>
                   <tr>
                ...
                <td><img class="widget" src="media/examples/dpickles.jpg" height="120px" /></td>
                   ...
                   <tr>
                <td><p>
                    <input Title="Tick to Enable Light Theme" type="radio" name="ENABLED" value="lighttheme" <?php echo ($config->get('ENABLED','THEMES') == "lighttheme")?'CHECKED':'';?> />
                    Light Theme</p></td>
                <td><p>
                    <input Title="Tick to Enable Hernandito Theme" type="radio" name="ENABLED" value="hernandito" <?php echo ($config->get('ENABLED','THEMES') == "hernandito")?'CHECKED':''; ?> />
                    Hernandito's Theme</p></td>
                <td><p>
                    <input Title="Tick to Enable DPickles Theme" type="radio" name="ENABLED" value="dpickles" <?php echo ($config->get('ENABLED','THEMES') == "dpickles")?'CHECKED':'';?> />
                    DPickles Theme</p></td>
              </tr>
                   <tr>
                ...
                <td><img src="media/examples/original.jpg" height="120" class="widget" /></td>
                   ...
                   <tr>
                <td><p>
                    <input Title="Tick to Enable Black Modern Glass Theme" type="radio" name="ENABLED" value="black_modern_glass" <?php echo ($config->get('ENABLED','THEMES') == "black_modern_glass")?'CHECKED':'';?> />
                    Black Modern Glass Theme</p></td>
                <td><p>
                    <input Title="Tick to Enable Space 6 Theme" type="radio" name="ENABLED" value="space6" <?php echo ($config->get('ENABLED','THEMES') == "space6")?'CHECKED':'';?> />
                    Space 6 Theme</p></td>
                <td><p>
                    <input Title="Tick to Disable all Themes" type="radio" name="ENABLED" value="" <?php echo ($config->get('ENABLED','THEMES') == "")?'CHECKED':''; ?> />
                    OFF</p></td>
              </tr>
                   <tr>
                <td colspan="3"><input type="button" value="Coming Episode Mods" Title="Click here to Choose Coming Episodes Style" onClick="window.location.href='#WIDGET_MODS'" />
                       ...
                       <br>
                       <p>
                    <input type="button" value="Save" Title="Save these Settings" onClick="updateSettings('THEMES');" />
                  </p></td>
              </tr>
                 </table>
          </div>
...
<!-- Coming Episodes Widget Mods -->
            ...
            <img src="media/Programs/cmods.png">
            ...
            <table>
                ...
                <td align="center"><input type="radio" name="CEVIEW" value="1" <?php echo ($config->get('CEVIEW','WIDGET_MODS') == "1")?'CHECKED':'';?> />
                       <p>Minimal Banner</p></td>
                <td align="center"><input type="radio" name="CEVIEW" value="2" <?php echo ($config->get('CEVIEW','WIDGET_MODS') == "2")?'CHECKED':'';?> />
...
<!-- WIDGETS ON & OFF -->
            ...
            <h3>Widget On/Off</h3>
            <img src="media/Programs/widgets.png">
